...
from GOETTINGEN_Profile_Mocks import goettingen_dataset_parsed_to_dict, goettingen_dataset_parsed_to_ckan_dict, resumption_token_ok, \
    ...
    ckan_dict_of_imported_dataset, goettingen_dict_of_imported_dataset, local_organization_data, local_dataset_data, goettingen_dataset_parsed_to_ckan_dict_map
...
def test_parse_goettingen_RECORD_DICT_to_LDM_CKAN_DICT_using_mapping():
    goettingen_dict = goettingen_dataset_parsed_to_dict

    parser = GOETTINGEN_ParserProfile()

    res_dict = parser.parse_goettingen_RECORD_DICT_to_LDM_CKAN_DICT_using_mapping(goettingen_dict)

    print("\n\nPARSED DICT MAP: \n", res_dict)

    assert res_dict == goettingen_dataset_parsed_to_ckan_dict_map
