...
leopard_dataset_parsed_to_ckan_dict = {
    ...
    'notes': 'Gene expression of Theobroma cacao was analyzed based on various reference sequences. All available paired-end RNA-seq datasets were downloaded from the Sequence Read Archive and processed with kallisto. Final count tables were generated with customized Python scripts.',
    'organization': {
        'approval_status': 'approved',
    ...
    'subject_areas': [{'subject_area_name': '580 Plants (Botany)'}],
    'tags': [{'display_name': 'Plant genetics', 
              'name': 'Plant genetics', 
              'state': 'active', 'vocabulary_id': None}, 
            {'display_name': 'RNA-Sequence', 
             'name': 'RNA-Sequence', 
             'state': 'active', 'vocabulary_id': None}, 
...
# OAI harvester parsed record — first record from leopard_dataset.xml via OAIHarvester.parse_record()
OAIHarvester_parsed_record = {'header': {'identifier': 'oai:https://leopard.tu-braunschweig.de/:dbbs_mods_00078205', 'datestamp': '2024-11-28', 'setSpecs': ['GENRE:research_data', 'ddc:5', 'ddc:58', 'doc-type:ResearchData', 'driver', 'open_access'], 'status': None}, 'metadata': {'metadataFormat': 'oai_datacite', 'identifier': {'value': '10.24355/dbbs.084-202411180831-0', 'identifierType': 'DOI'}, 'creators': [{'creatorName': {'value': 'Pucker, Boas', 'nameType': 'Personal'}, 'givenName': 'Boas', 'familyName': 'Pucker', 'nameIdentifiers': [{'value': '1191400093', 'nameIdentifierScheme': 'GND', 'schemeURI': None}, {'value': '0000-0002-3321-7471', 'nameIdentifierScheme': 'ORCID', 'schemeURI': 'http://orcid.org/'}], 'affiliations': [{'value': 'Institut für Pflanzenbiologie', 'affiliationIdentifier': None, 'affiliationIdentifierScheme': None, 'schemeURI': None}]}], 'titles': [{'value': 'Gene Expression of Theobroma cacao', 'titleType': None, 'lang': 'de'}], 'publisher': {'value': 'Universitätsbibliothek Braunschweig', 'publisherIdentifier': None, 'publisherIdentifierScheme': None, 'schemeURI': None, 'lang': None}, 'publicationYear': '2024', 'resourceType': {'value': 'research_data', 'resourceTypeGeneral': 'Dataset'}, 'subjects': [{'value': 'Plant genetics', 'subjectScheme': None, 'schemeURI': None, 'valueURI': None, 'lang': None}, {'value': 'RNA-Sequence', 'subjectScheme': None, 'schemeURI': None, 'valueURI': None, 'lang': None}, {'value': 'Gene expression', 'subjectScheme': None, 'schemeURI': None, 'valueURI': None, 'lang': None}, {'value': '58', 'subjectScheme': 'ddc', 'schemeURI': None, 'valueURI': None, 'lang': None}], 'contributors': [{'contributorType': 'HostingInstitution', 'contributorName': {'value': 'Universitätsbibliothek Braunschweig', 'nameType': None}, 'givenName': None, 'familyName': None, 'nameIdentifiers': [], 'affiliations': []}], 'dates': [{'value': '2024-11-28', 'dateType': 'Issued', 'dateInformation': None}], 'language': 'en', 'alternateIdentifiers': [{'value': 'https://leopard.tu-braunschweig.de/receive/dbbs_mods_00078205', 'alternateIdentifierType': 'URL'}, {'value': 'dbbs_mods_00078205', 'alternateIdentifierType': 'MyCoRe'}], 'relatedIdentifiers': [{'value': 'https://leopard.tu-braunschweig.de/receive/dbbs_mods_00078205?XSL.Transformer=mods', 'relationType': 'HasMetadata', 'relatedIdentifierType': 'URL', 'relatedMetadataScheme': 'mods', 'schemeURI': 'https://www.loc.gov/standards/mods/v3/mods-3-7.xsd', 'schemeType': None, 'resourceTypeGeneral': None}], 'sizes': [], 'formats': [], 'version': None, 'rightsList': [{'value': 'Attribution 4.0', 'rightsURI': 'https://creativecommons.org/licenses/by/4.0/', 'rightsIdentifier': 'CC-BY-4.0', 'rightsIdentifierScheme': None, 'schemeURI': None, 'lang': 'en'}], 'descriptions': [{'value': 'Gene expression of Theobroma cacao was analyzed based on various reference sequences. All available paired-end RNA-seq datasets were downloaded from the Sequence Read Archive and processed with kallisto. Final count tables were generated with customized Python scripts.', 'descriptionType': 'Abstract', 'lang': 'en'}], 'geoLocations': [], 'fundingReferences': [], 'relatedItems': []}}

# Expected result of applying LEO_profile_mapping.json to OAIHarvester_parsed_record.
OAIHarvester_mapping_ckan_dict = {'repository_name': 'LeoPARD (TU Braunschweig Publications And Research Data)', 'type': 'vdataset', 'source_metadata_created': '2024', 'source_metadata_modified': '', 'owner_org': 'leopard', 'authors': [{'author': 'Pucker, Boas', 'givenName': 'Boas', 'familyName': 'Pucker', 'orcid': '0000-0002-3321-7471'}], 'author_email': '', 'doi': '10.24355/dbbs.084-202411180831-0', 'doi_date_published': '2024', 'doi_publisher': '', 'doi_status': 'True', 'license_id': 'CC-BY-4.0', 'license_title': 'Attribution 4.0', 'name': 'leo-doi-10-24355-dbbs-084-202411180831-0', 'notes': 'Gene expression of Theobroma cacao was analyzed based on various reference sequences. All available paired-end RNA-seq datasets were downloaded from the Sequence Read Archive and processed with kallisto. Final count tables were generated with customized Python scripts.', 'organization': {'approval_status': 'approved', 'description': 'Technische Universität Braunschweig - Universitätsbibliothek Braunschweig.', 'display_name': 'leoPARD (TU Braunschweig Publications And Research Data)', 'image_display_url': 'logo-leopard-white.png', 'image_url': 'logo-leopard-white.png', 'is_organization': True, 'name': 'leopard', 'state': 'active', 'title': 'leoPARD (TU Braunschweig Publications And Research Data)', 'type': 'organization'}, 'title': 'Gene expression of theobroma cacao', 'url': 'https://doi.org/10.24355/dbbs.084-202411180831-0', 'citation': [], 'publication_year': '2024', 'subject_areas': [{'subject_area_name': '580 Plants (Botany)'}], 'tags': [{'display_name': 'Plant genetics', 'name': 'Plant genetics', 'state': 'active', 'vocabulary_id': None}, {'display_name': 'RNA-Sequence', 'name': 'RNA-Sequence', 'state': 'active', 'vocabulary_id': None}, {'display_name': 'Gene expression', 'name': 'Gene expression', 'state': 'active', 'vocabulary_id': None}], 'resource_type': 'Dataset - research_data', 'related_identifiers': [{'identifier': 'https://leopard.tu-braunschweig.de/receive/dbbs_mods_00078205?XSL.Transformer=mods', 'identifier_type': 'URL', 'relation_type': 'HasMetadata'}]}