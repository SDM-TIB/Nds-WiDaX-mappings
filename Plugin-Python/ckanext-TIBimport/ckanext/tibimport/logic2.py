...
class LDM_DatasetImport:
    ...
    def _insert_update_skip_dataset(self, remote_dataset):
        ...
        if dataset == {}: # Not Found
            ...
            self.ds_parser.execute_after_insert_dataset(remote_dataset)
...
class DatasetParser():
    ...
    def execute_after_insert_dataset(self, remote_dataset):
        '''
            This method can be overridden inside a Dataset Parser Profile
            to run logic after a dataset has been inserted (including after_create hooks).
        '''
        return remote_dataset
